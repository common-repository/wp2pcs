...
备份WordPress到百度网盘，调用网盘内的资源到网站使用。
...
1、后台“安装插件”搜索“WP2PCS”进行安装；或者，下载插件，把wp2pcs文件夹上传到/wp-content/plugins/目录<br />
2、在后台插件列表中启用它<br />
3、在“设置-WP2PCS”菜单中，点击授权按钮，等待授权跳转<br />
